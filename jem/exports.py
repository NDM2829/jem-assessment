...
def write_manifest(path: str | Path, *, forecasts: tuple[Forecast, ...], input_hashes: dict[str, str],
    ...
    document = {
        ...
        "limitations": "Overlap-affected sums are suspect, not confirmed worked hours or confirmed breaches. Stage 3 prediction only; note validation and other assessment outputs remain pending.",
    }
